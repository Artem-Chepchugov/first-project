...
import { getInitialCards, editProfile, addNewCard, getUserInfo, editImage, deleteCard } from './api.js';
...
function handleCardFormSubmit(evt) {
    ...
    addNewCard(placeNameInput.value, linkInput.value)
        .then(() => {
            placesList.prepend(createCard(placeNameInput.value, linkInput.value, placeNameInput.value, popupImage, imageInPopup, imageInPopupCaption, [], currentUserId));
...
document.querySelectorAll('.element__delete-icon').forEach(icon => {
